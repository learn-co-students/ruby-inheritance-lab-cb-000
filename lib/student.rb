...
# We've given you a barebones Student class. Change the class definition so that
# it inherits from the User class. Run the test suite and notice that you are
# passing some tests for the Student class, even without writing any code inside
# that class. That is because it will inherit the #first_name and #last_name methods
